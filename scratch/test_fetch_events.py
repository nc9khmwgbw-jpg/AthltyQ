...
b.driver.get("https://www.sofascore.com/player/jude-bellingham/958981")
time.sleep(5)

script = """
return await fetch('https://api.sofascore.com/api/v1/player/958981/events/last/0').then(r => r.json()).catch(e => ({'err': e.message}));
"""
try:
